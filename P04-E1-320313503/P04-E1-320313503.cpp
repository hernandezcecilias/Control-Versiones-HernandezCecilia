...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// CABINA (Punto de origen del modelo)
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -4.0f, -25.0f));
		modelaux = model;
		glm::mat4 modelCabina = glm::scale(model, glm::vec3(7.0f, 4.0f, 5.0f));
		...
		model = modelaux;
		// La bajamos en Y para atravesar cabina
		model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
		glm::mat4 modelBaseLlantas = model;
		model = glm::scale(model, glm::vec3(6.0f, 4.0f, 5.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //Piramide Cuadrangular


	 // RUEDAS
       // Llanta 1 (Delante Derecha)
		model = modelaux;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::translate(model, glm::vec3(-4.0f, 3.0f, 3.0f));
		model = glm::scale(model, glm::vec3(1.8f, 0.8f, 1.8f));
		...
		// Llanta 2 (Delante Izquierda)
		model = modelaux;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::translate(model, glm::vec3(-4.0f, -3.2f, 2.65f)); 
		...
		// ARTICULACIÓN 1 Y PRIMER BRAZO
		model = modelaux; // Partimos del centro de la cabina de nuevo
		...
		// ARTICULACIÓN 2 Y SEGUNDO BRAZO
		model = modelaux;
		model = glm::translate(model, glm::vec3(2.5f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;

		// Esfera de articulación 2
