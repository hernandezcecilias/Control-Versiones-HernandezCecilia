...
int main()
{
	...
	CuerpoCarro_M = Model();
	CuerpoCarro_M.LoadModel("Models/carro_cuerpo.fbx");

	LlantaIzquierdaDel_M = Model();
	LlantaIzquierdaDel_M.LoadModel("Models/llanta_izquierda.fbx");

	LlantaIzquierdaTras_M = Model();
	LlantaIzquierdaTras_M.LoadModel("Models/llanta_izquierda1.fbx");

	LlantaDerechaDel_M = Model();
	LlantaDerechaDel_M.LoadModel("Models/llanta_derecha.fbx");

	LlantaDerechaTras_M = Model();
	LlantaDerechaTras_M.LoadModel("Models/llanta_derecha1.fbx");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Carro base
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -2.0f, mainWindow.getposicionCarro()));
