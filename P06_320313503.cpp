...
void CrearDado8()
{
  ...
  // average normals
	...
	GLfloat octa_vertices[] = {
        ...
        //x		y		z		S		T			NX		NY		NZ
		//
		-0.5f,  0.0f,  0.5f,   0.00f, 0.75f,    0.0f, 0.707f, 0.707f,
		0.5f,  0.0f,  0.5f,   0.25f, 0.50f,    0.0f, 0.707f, 0.707f,
		0.0f,  0.5f,  0.0f,   0.50f, 0.75f,    0.0f, 0.707f, 0.707f,

		//8
		//x		y		z		S		T
		0.5f,  0.0f,  0.5f,   0.25f, 0.50f,  0.707f, 0.707f,  0.0f,
		0.5f,  0.0f, -0.5f,   0.75f, 0.50f,  0.707f, 0.707f,  0.0f,
		0.0f,  0.5f,  0.0f,   0.50f, 0.75f,  0.707f, 0.707f,  0.0f,

		//5
		//x		y		z		S		T
		0.5f,  0.0f, -0.5f,   0.75f, 0.50f,    0.0f, 0.707f,-0.707f,
		-0.5f,  0.0f, -0.5f,   1.00f, 0.75f,    0.0f, 0.707f,-0.707f,
		0.0f,  0.5f,  0.0f,   0.50f, 0.75f,    0.0f, 0.707f,-0.707f,

		//4
		//x		y		z		S		T
		-0.5f,  0.0f, -0.5f,   0.25f, 1.00f, -0.707f, 0.707f,  0.0f,
		-0.5f,  0.0f,  0.5f,   0.00f, 0.75f, -0.707f, 0.707f,  0.0f,
		0.0f,  0.5f,  0.0f,   0.50f, 0.75f, -0.707f, 0.707f,  0.0f,

		//6
		//x		y		z		S		T
		0.5f,  0.0f,  0.5f,   0.00f, 0.25f,    0.0f,-0.707f, 0.707f,
		-0.5f,  0.0f,  0.5f,   0.25f, 0.50f,    0.0f,-0.707f, 0.707f,
		0.0f, -0.5f,  0.0f,   0.50f, 0.25f,    0.0f,-0.707f, 0.707f,

		//3
		//x		y		z		S		T
		0.5f,  0.0f, -0.5f,   0.25f, 0.50f,  0.707f,-0.707f,  0.0f,
		0.5f,  0.0f,  0.5f,   0.75f, 0.50f,  0.707f,-0.707f,  0.0f,
		0.0f, -0.5f,  0.0f,   0.50f, 0.25f,  0.707f,-0.707f,  0.0f,

		//2
		//x		y		z		S		T
		-0.5f,  0.0f, -0.5f,   1.00f, 0.25f,    0.0f,-0.707f,-0.707f,
		0.5f,  0.0f, -0.5f,   0.75f, 0.50f,    0.0f,-0.707f,-0.707f,
		0.0f, -0.5f,  0.0f,   0.50f, 0.25f,    0.0f,-0.707f,-0.707f,

		//7
		//x		y		z		S		T
		-0.5f,  0.0f,  0.5f,   0.00f, 0.25f, -0.707f,-0.707f,  0.0f,
		-0.5f,  0.0f, -0.5f,   0.25f, 0.00f, -0.707f,-0.707f,  0.0f,
		0.0f, -0.5f,  0.0f,   0.50f, 0.25f, -0.707f,-0.707f,  0.0f
	};
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//la imagen dado_animales ya optimizada por ustedesll
		//Dado importado
		model = glm::mat4(1.0);
		...
		*/
		...
		// Dado de 8 caras
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-1.5f, 2.5f, 6.0f));
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(mainWindow.getmuevex(), -2.0f, -3.0f));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.8f, 0.3f, 1.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		LlantaDerechaDel_M.RenderModel();

		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.8f, 0.3f, -1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
